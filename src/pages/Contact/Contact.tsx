    ...
    <React.Fragment>
      <div className={styles.main}>
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url('https://nitkkr.ac.in/wp-content/uploads/2022/01/24131961_285405678647849_426967072086000359_o.jpg')",
          }}
        >
          <div
            style={{
          ...
          >
            <div className={styles.inside}>
              ...
              <div>
                <h5>
                  <b>Placement and Training Cell</b>
                </h5>
