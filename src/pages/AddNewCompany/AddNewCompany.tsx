...
function AddNewCompany() {
  ...
  const changeUgStyle = () => {
    if (!ugShow) {
      setUgShow(true);
      setUgDisplay({ display: "inline" });
    } else {
      setUgShow(false);
      setUgDisplay({ display: "none" });
    }
  };
      ...
      <div className="main_wrapper">
        ...
        <div className="boxes">
          ...
          <div className="form-row">
            ...
            <div className="form-group col-md-6">
              <label htmlFor="exampleFormControlSelect1">Passout Batch</label>
              <br></br>
              <select
                className="form-select form-select-sm"
                aria-label=".form-select-sm example"
          ...
          <div className="form-row">
            <div className="form-group col-md-6">
              <label htmlFor="exampleFormControlSelect1">Recruitment</label>
              <br></br>
              <select
                className="form-select form-select-sm"
                aria-label=".form-select-sm example"
          ...
          <div className="form-row">
            <div className="form-group col-md-6">
              ...
              <input
                ...
                className="form-control"
                id="location"
                placeholder="Enter Posting Details"
              />
            </div>
        ...
        <div className="boxes">
          ...
          <div className="ug" id="ug_branches" style={ugDisplay}>
          ...
          <div className="ug" id="ug_branches" style={pgDisplay}>
            <label htmlFor="eligible_programs">Eligible M.Tech Branches</label>
            <br></br>
            <div className="form-check form-check-inline big_checkbox">
              <input
                className="form-check-input"
          ...
          <div className="form-row">
            ...
            <div className="form-group col-md-6">
              ...
              <input
                ...
                className="form-control"
                id="date"
                placeholder="Enter minimum % marks in 10th"
              />
            </div>
          </div>
          ...
          <div className="form-row">
            <div className="form-group col-md-6">
              ...
              <input
                ...
                className="form-control"
                id="location"
                placeholder="Enter minimum % marks in 12th"
              />
            </div>
          ...
          <div className="form-row">
            <div className="form-group col-md-6">
              ...
              <input
                ...
                className="form-control"
                id="location"
                placeholder="Enter Other Eligibilty"
              />
            </div>
          </div>
        </div>
