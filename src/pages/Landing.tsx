    ...
    <>
        ...
        <div className="col-md-7 align-self-center text-right">
          <div className="d-flex justify-content-end align-items-center dropdown">
            ...
            <ul className="dropdown-menu" aria-labelledby="dropdownMenuLink">
              ...
              <li>
                <a className="dropdown-item" href="/stats19-20">
                  Placements 2019-20
                </a>
              </li>
            </ul>
      ...
      <div className="row">
        ...
        <i className="icon-like"></i> {{ main.student_name.split(' ')[0] }}, we need your feedback!
            ...
            feature in mind, please share your thoughts on feedback page. We are
            very interested in any feedback you have about using it!
            <br />
            <br />
        ...
        <div className="col-lg-12" ng-show="main.isLoggedIn">
          <div className="alert alert-info">
            ...
            Appeared for an interview? Share details about the interview process
            you have been through.. Now, you can add your placement/internship
            interview experience under Compose Interview Experience section to
            help others.
            <br />
            <br />
